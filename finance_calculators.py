def calculate_investment(deposit_amount, interest_rate, years, interest):
...
def calculate_bond(present_value, interest_rate, months):
    present_value = float(input("Enter the present value of the house: "))
    interest_rate = float(input("Enter the monthly interest rate: "))
    months = float(input("Enter the amount of months in which u want to pay the bond: "))
    repayment = ((interest_rate/12)*present_value)/(1 - (1+(interest_rate/12))**(-months))
...
while True:
    ...
    if calculation_type.lower() == "exit":
        break

    elif calculation_type.lower() == "investment":
        calculate_investment(deposit_amount=0, interest_rate=0, years=0, interest="") 

    elif calculation_type.lower() == "bond":
        calculate_bond(present_value=0, interest_rate=0, months=0)
